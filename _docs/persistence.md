...
| #23 | Customers and imports | PostgreSQL adapters exist; acceptance verified separately |
| #24 | Ownership, rules and audit | PostgreSQL adapters exist; acceptance verified separately |
