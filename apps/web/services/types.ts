...
export type AssignmentField = "bcn" | "MBCN" | "customer_name" | "propensityScore" | "propensityTier" | "propensityRank" | "previouslyContacted" | "recent" | "LAST_PURCHASE_DATE" | "REVENUE_AMOUNT_2024" | "REVENUE_AMOUNT_2025" | "REVENUE_AMOUNT_2026" | "FEM_AMOUNT_2024" | "FEM_AMOUNT_2025" | "FEM_AMOUNT_2026" | "Inside_Lead" | "Field_Rep" | "SC_Naming" | "Inside_Rep" | "Branch_Code" | "RSM_Name" | "Originating_BU" | "Payment_Terms";
export type AssignmentOperator = "=" | "!=" | "contains" | "in" | "<" | "<=" | ">" | ">=" | "between" | "is-null" | "is-not-null";
export type AssignmentRule = { id: string; name: string; active: boolean; position: number; field: AssignmentField; operator: AssignmentOperator; value: string; eligibleSalesIds: string[] };
export type AssignmentRunInput = { scope: "unassigned" | "all" | "selected"; selectedBcns?: string[]; submissionId?: string; expectedVersion?: number };
